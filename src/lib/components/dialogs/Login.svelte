<script lang="ts">
    ...
    let error:string=''
    const dialog_close=()=>{
        const welcome_toast=document.getElementById('login') as HTMLDivElement
    ...
    <div id="login" style="background:rgba(0, 0, 0, 0.1); display:none;" on:dblclick={dialog_close} class="fixed bottom-0 top-0 left-0 right-0 z-40">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="pb-4 px-8 lg:w-[35vw] md:w-[45vw] sm:w-[55vw]">
                        ...
                        <form class="flex flex-col items-center max-sm:text-xs my-4" on:submit={handleAdd}>
                            <p class="text-xl max-md:text-lg mb-1 max-sm:text-sm">Enter username</p>
